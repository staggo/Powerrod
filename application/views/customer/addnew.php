<div class="container" id="newcustomer">
    <div class="row">
        ...
        <div class="col-md-5 text-right" style="position:relative; top:20px; margin-bottom:20px;">
            ...
            <a href="<?php echo $this->config->item('base_url');?>index.php/customer/insert"><button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-ok-sign"></span> Save</button></a>
    	</div>
    </div><!--/row-->
...
<!--column 1-->
		<div class="col-md-4">
			...
			<div class="form-group">  
             ...
             <div class="form-group">  
                ...
                <textarea name="customer_address" id="customer_address" class="form-control" rows="4"></textarea>
			</div>
			<div class="form-group">  
            	<label for="customer_postcode">Postcode</label>
                <input type="text" name="customer_postcode" id="customer_postcode" class="form-control"/>
			</div>
            <div class="form-group">  
        ...
        <div class="col-md-4">
           ...
           <div class="form-group">
                ...
                <textarea name="customer_notes" id="customer_notes" class="form-control" rows="10"></textarea>
			</div>
